...
// Calibrated with user-customized multi-device focal coordinates
...
export const DEFAULT_IMAGE_CONFIGS: Record<string, ImageBreakpointConfig> = {
  "about-hero": {
    ...
    mobile: { x: 79, y: 38, scale: 100 },
    tablet: { x: 71, y: 27, scale: 103 },
    desktop: { x: 70, y: 35, scale: 103 },
  ...
  "speaking-hero": {
    ...
    mobile: { x: 65, y: 48, scale: 100 },
    tablet: { x: 64, y: 50, scale: 101 },
    desktop: { x: 65, y: 52, scale: 101 },
  ...
  "about-quote": {
    ...
    mobile: { x: 88, y: 60, scale: 115 },
    tablet: { x: 76, y: 55, scale: 104 },
    desktop: { x: 83, y: 65, scale: 117 },
  ...
  "about-sagar": {
    ...
    mobile: { x: 45, y: 53, scale: 103 },
    tablet: { x: 45, y: 38, scale: 101 },
    desktop: { x: 45, y: 50, scale: 100 },
  ...
  "newsletter": {
    ...
    mobile: { x: 47, y: 20, scale: 98 },
    tablet: { x: 45, y: 24, scale: 100 },
    desktop: { x: 46, y: 23, scale: 100 },
    tailwind: "object-cover object-[47%_20%] sm:object-[45%_24%] lg:object-[46%_23%]",
  },
  "casual-1": {
    id: "casual-1",
    ...
    mobile: { x: 52, y: 42, scale: 100 },
    tablet: { x: 50, y: 44, scale: 100 },
    desktop: { x: 50, y: 46, scale: 104 },
  ...
  "casual-2": {
    ...
    mobile: { x: 50, y: 59, scale: 100 },
    tablet: { x: 50, y: 60, scale: 100 },
    desktop: { x: 50, y: 62, scale: 100 },
  ...
  "casual-3": {
    ...
    mobile: { x: 18, y: 53, scale: 103 },
    tablet: { x: 28, y: 59, scale: 100 },
    desktop: { x: 50, y: 58, scale: 100 },
  ...
  "casual-4": {
    ...
    mobile: { x: 44, y: 54, scale: 98 },
    tablet: { x: 46, y: 52, scale: 103 },
    desktop: { x: 44, y: 50, scale: 105 },
  ...
  "casual-5": {
    ...
    mobile: { x: 26, y: 62, scale: 102 },
    tablet: { x: 29, y: 71, scale: 100 },
    desktop: { x: 50, y: 70, scale: 100 },
  ...
  "contact-hero": {
    ...
    mobile: { x: 51, y: 61, scale: 100 },
    tablet: { x: 51, y: 58, scale: 100 },
    desktop: { x: 52, y: 34, scale: 100 },
