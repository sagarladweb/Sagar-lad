...
const PRESET_METADATA: PresetItem[] = [
  ...
  },
  {
    ...
    hasTextOverlay: false,
    centerGuide: {
      mobileFace: { x: 50, y: 50, scale: 100 },
      tabletFace: { x: 50, y: 50, scale: 100 },
      desktopFull: { x: 50, y: 50, scale: 100 },
    },
  },
  {
    id: "newsletter",
  ...
  },
  {
    ...
    hasTextOverlay: false,
    centerGuide: {
      mobileFace: { x: 50, y: 25, scale: 100 },
      tabletFace: { x: 50, y: 25, scale: 100 },
      desktopFull: { x: 50, y: 25, scale: 100 },
    },
  },
  {
    id: "contact-hero",
