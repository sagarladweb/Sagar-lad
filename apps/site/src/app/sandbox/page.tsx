...
const PRESET_METADATA: PresetItem[] = [
  ...
  },
  {
    ...
    hasTextOverlay: false,
    centerGuide: {
      mobileFace: { x: 45, y: 50, scale: 100 },
      tabletFace: { x: 45, y: 50, scale: 100 },
  ...
  },
  {
    ...
    hasTextOverlay: false,
    centerGuide: {
      mobileFace: { x: 50, y: 61, scale: 100 },
      tabletFace: { x: 48, y: 64, scale: 100 },
      desktopFull: { x: 50, y: 60, scale: 100 },
    },
  },
  {
    id: "contact-hero",
