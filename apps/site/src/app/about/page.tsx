        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 min-h-[100svh] flex flex-col justify-end py-12 sm:py-24 md:py-32">
          <div className="max-w-3xl text-center sm:text-left mt-auto" style={{ display: "grid", gap: "0" }}>
            ...
            <div data-reveal className="mb-8">
              ...
              <p className="mt-2 font-display text-2xl sm:text-3xl md:text-4xl font-bold text-black bg-[#ffd51d] inline-block px-3 py-1 rounded-sm">
                Change your <span>MIND</span>
              </p>
              <p className="font-display text-2xl sm:text-3xl md:text-4xl font-bold text-black bg-[#ffd51d] inline-block px-3 py-1 rounded-sm">
      ...
      <section id="running" className="card-hover scroll-mt-32 py-16 md:py-28 border-b border-border bg-card/30">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
            ...
            {/* Right: marathon image cards with race info */}
