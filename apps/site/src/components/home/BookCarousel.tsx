          ...
          <div key={book.id} className="book-slide-enter">
            ...
            <div className="relative w-full md:w-2/5 lg:w-2/5 shrink-0 flex justify-center pb-12 md:pb-0">
              ...
              >
                ...
                <div className="flex absolute -bottom-10 left-1/2 -translate-x-1/2 pointer-events-none flex-col items-center opacity-80 group-hover/book:opacity-100 transition-opacity">
