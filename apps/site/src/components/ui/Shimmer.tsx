const SHINE_CLASS =
  "absolute inset-0 -translate-x-full animate-[shimmer_1.8s_infinite_cubic-bezier(0.4,0,0.2,1)] bg-[linear-gradient(105deg,transparent_0%,rgba(255,255,255,0.05)_25%,rgba(255,255,255,0.75)_50%,rgba(255,255,255,0.05)_75%,transparent_100%)] dark:bg-[linear-gradient(105deg,transparent_0%,rgba(255,255,255,0.02)_25%,rgba(255,255,255,0.18)_50%,rgba(255,255,255,0.02)_75%,transparent_100%)]";

export function Shimmer({ className = "" }: { className?: string }) {
  return (
    <div className={`relative overflow-hidden rounded-md bg-muted ${className}`}>
      <div className={SHINE_CLASS} />
    </div>
  );
}
