...
export const BLOCK_DEFS: Record<BlockType, BlockDef> = {
  ...
  image: {
    type: "image",
    label: "Image / Banner",
    description: "Image with caption or full-width banner with overlay",
    category: "Media",
    icon: ImageIcon,
  ...
  banner: {
    type: "banner",
    label: "Banner (legacy)",
    description: "Full-width image banner — use Image block with Banner toggle instead",
    category: "Media",
    icon: PanelTop,
  ...
  socialShare: {
    type: "socialShare",
    label: "Social & Share",
    description: "Follow links, share prompt, and CTA",
    category: "Newsletter",
    icon: Share2,
    ...
    defaultData: {
      ...
      showCta: true,
      showSocials: true,
      platformOrder: ["x", "linkedin", "instagram", "youtube", "tiktok", "threads", "whatsapp", "substack", "website"],
      platform_x: true,
    ...
    fields: [
      ...
      text("platformLabel_x", "Custom label", { section: "Platforms", placeholder: "Default" }),
      toggle("platform_linkedin", "LinkedIn", { section: "Platforms" }),
      text("platformLabel_linkedin", "Custom label", { section: "Platforms", placeholder: "Default" }),
      toggle("platform_instagram", "Instagram", { section: "Platforms" }),
      text("platformLabel_instagram", "Custom label", { section: "Platforms", placeholder: "Default" }),
      toggle("platform_youtube", "YouTube", { section: "Platforms" }),
      text("platformLabel_youtube", "Custom label", { section: "Platforms", placeholder: "Default" }),
      toggle("platform_tiktok", "TikTok", { section: "Platforms" }),
      text("platformLabel_tiktok", "Custom label", { section: "Platforms", placeholder: "Default" }),
      toggle("platform_threads", "Threads", { section: "Platforms" }),
      text("platformLabel_threads", "Custom label", { section: "Platforms", placeholder: "Default" }),
      toggle("platform_whatsapp", "WhatsApp", { section: "Platforms" }),
      text("platformLabel_whatsapp", "Custom label", { section: "Platforms", placeholder: "Default" }),
      toggle("platform_substack", "Substack", { section: "Platforms" }),
      text("platformLabel_substack", "Custom label", { section: "Platforms", placeholder: "Default" }),
      toggle("platform_website", "Website", { section: "Platforms" }),
      text("platformLabel_website", "Custom label", { section: "Platforms", placeholder: "Default" }),
    ],
    styleOverride: {
      borderEnabled: true,
      borderColor: "#E4E8F5",
