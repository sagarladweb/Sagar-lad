...
export const BLOCK_DEFS: Record<BlockType, BlockDef> = {
  ...
  greeting: {
    type: "greeting",
    label: "Greeting",
    description: "Personalized greeting with {name} placeholder",
    category: "Newsletter",
    icon: HandMetal,
  ...
  socialButton: {
    type: "socialButton",
    label: "Social Button",
    description: "Single social media button",
    category: "Newsletter",
    icon: Share2,
    keywords: ["social", "follow", "platform", "link"],
    swatch: "#0F172A",
    defaultData: {
      platform: "x",
      name: "Follow on X",
    ...
    fields: [
      ...
      text("name", "Button label", { placeholder: "Follow on X" }),
      text("url", "URL"),
    ],
    styleOverride: { paddingTop: 8, paddingBottom: 8 },
  },

  socialButtons: {
    type: "socialButtons",
    label: "Social Buttons",
    description: "Multiple social media buttons",
    category: "Newsletter",
    icon: Share2,
    keywords: ["social", "follow", "platforms", "links"],
    swatch: "#1E40AF",
    defaultData: {
      platforms: [
