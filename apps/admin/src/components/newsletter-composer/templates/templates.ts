   ...
   * ================================================================ */
  {
    ...
    blocks: () =>
      createBlocks([
        ...
        ["columns3", { columns: [{ heading: "Media", body: "Images, galleries, GIFs, video embeds, and tweet cards." }, { heading: "Newsletter", body: "Hero, subscribe, share, social, author card, and footer." }, { heading: "Database", body: "Books, e-books, quotes, videos, and blog posts from your CMS." }] }],
        ...
        ["table", { headers: [{ text: "Block type" }, { text: "Category" }, { text: "Use case" }], rows: [{ cells: "Hero|Newsletter|Issue opening" }, { cells: "Table|Layout|Structured data" }, { cells: "Timeline|Layout|Sequenced milestones" }, { cells: "FAQ|Layout|Reader questions" }], striped: true }],
        ["timeline", { items: [{ date: "Step 1", title: "Choose a template", body: "Start with a pre-built layout or blank canvas.", color: "#1D4ED8" }, { date: "Step 2", title: "Add your blocks", body: "Drag, drop, and reorder sections.", color: "#B45309" }, { date: "Step 3", title: "Style it", body: "Adjust fonts, colors, and spacing.", color: "#059669" }, { date: "Step 4", title: "Ship it", body: "Preview, check, and send.", color: "#DC2626" }] }],
        ...
        ["faq", { title: "Frequently asked questions", style: "bordered", expandFirst: true, items: [{ question: "How many block types are available?", answer: "42 block types across Writing, Layout, Media, Newsletter, and Database categories." }, { question: "Can I rearrange blocks after adding them?", answer: "Yes — drag any block to reorder, or use the duplicate/delete controls." }, { question: "Do database blocks auto-populate?", answer: "They pull from your CMS. Select specific items or let them auto-fill with your latest content." }] }],
   ...
   * ================================================================ */
  {
    ...
    blocks: () =>
      createBlocks([
        ...
        ["columns3", { columns: [{ heading: "Writing", body: "Ship the smallest useful version." }, { heading: "Reading", body: "One book that changed my week." }, { heading: "Building", body: "The tool that saved me hours." }] }],
        ...
        ["timeline", { items: [{ date: "Mon", title: "Published new blog", body: "The complete guide to newsletter blocks.", color: "#1D4ED8" }, { date: "Wed", title: "Shipped video", body: "Two-minute composer walkthrough.", color: "#B45309" }, { date: "Fri", title: "Weekly digest", body: "This issue — every block type showcased.", color: "#059669" }] }],
